...
document.addEventListener("DOMContentLoaded", () => {
  ...
  `;
    ...
    const FORM_ENDPOINT = ""; // test phase — pas de domaine valide, simulation seule (remettre https://formsubmit.co/ajax/contact@kids-training-reunion.re quand domaine actif)
